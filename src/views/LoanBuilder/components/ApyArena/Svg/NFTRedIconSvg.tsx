const NFTRedIconSvg = (props) => {
    ...
    return (
        ...
        <text fill="#E83232" font-family="Geist" font-size="12" font-weight="600" letter-spacing="-0.02em">
            <tspan x="96.182" y="22.2">Top 25</tspan>
        </text>
        <g filter="url(#filter0_d_851_545)">
        <text fill="#E83232" font-family="Geist" font-size="24" font-weight="500" letter-spacing="-0.02em">
            <tspan x="88" y="110.4" data-tip={apy + "%"}>
